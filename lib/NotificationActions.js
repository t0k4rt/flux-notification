...
var NotificationActions = (function () {
  ...
  _createClass(NotificationActions, [{
    ...
    key: "success",
    value: function success(_message) {
      var _context = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];

      this.dispatcher.dispatch({
        type: this.constants.actions.create,
        record: new _NotificationRecord.NotificationRecord({ level: _NotificationRecord.levels.SUCCESS, message: _message, context: _context })
      });
    }
  }, {
    key: "info",
